...
from utils.ai_advanced_new import get_advanced_korean_response
from utils.japanese_ai_advanced import get_advanced_japanese_response
...
async def handle_korean_conversation(message: Message, state: FSMContext):
    ...
    try:
        ...
        # AI javob olish (Advanced system)
        ai_response = await get_advanced_korean_response(user_message, user_id)
...
async def handle_japanese_conversation(message: Message, state: FSMContext):
    ...
    try:
        ...
        # AI javob olish (Advanced Japanese system)
        ai_response = await get_advanced_japanese_response(user_message, user_id)
